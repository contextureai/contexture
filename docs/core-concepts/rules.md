...
-   **[Formats](formats.md)**: How rules are transformed for different platforms.
-   **[Variables](variables.md)**: Advanced variable usage and template functions.
-   **[Projects](projects.md)**: Organizing rules within projects.
